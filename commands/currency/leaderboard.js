...
module.exports = {
    ...
    category: 'currency',
    description:
        'Display list of users containing the most Super Deluxe Cheese Coins',
            ...
            try {
                ...
                if (!user.length) {
                    const embedNoUsers = new MessageEmbed()
                        ...
                        .setDescription(
                            `There are no recorded users in the database.`
                        )
                        .setFooter(
                ...
                var setup = new Promise((resolve, reject) => {
                    ...
                    user.forEach(async function (user, i) {
                        const username = await client.users.cache.get(
                            user.userID
                        ).tag;
